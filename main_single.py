...
from single_poisoned_dataset import create_backdoor_data_loader
from single_utils import loss_picker, optimizer_picker, backdoor_model_trainer, save_experiments
...
parser.add_argument('--polarity', default=3, type=int,
...
parser.add_argument('--type', default='static', type=str,
                    help='The type of the trigger', choices=['static', 'moving', 'smart', 'latency', 'rate', 'jitter', 'jitter_fixed'])
...
# Temporal trigger specific parameters
parser.add_argument('--delay_frames', default=2, type=int,
                    help='Number of frames to delay for latency trigger')
parser.add_argument('--scale_factor', default=0.5, type=float,
                    help='Temporal rate scaling factor for rate trigger (<1.0 faster, >1.0 slower)')
parser.add_argument('--n_shift', default=3, type=int,
                    help='Number of frame pairs to swap for jitter_fixed trigger')

# Other
parser.add_argument('--data_dir', type=str,
                    default='data/', help='Data directory')
parser.add_argument('--save_path', type=str,
                    default='experiments_single', help='Path to save the experiments')
